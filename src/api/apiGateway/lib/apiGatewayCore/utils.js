...
var apiGatewayUtils = apiGatewayUtils || {};
apiGatewayUtils.core = apiGatewayUtils.core || {};

apiGatewayUtils.core.utils = {
    ...
    assertParametersDefined: function (params, keys, ignore) {
        ...
        for (var i = 0; i < keys.length; i++) {
            if(!apiGatewayUtils.core.utils.contains(ignore, keys[i])) {
                apiGatewayUtils.core.utils.assertDefined(params[keys[i]], keys[i]);
            }
        }
    },
...
export default apiGatewayUtils
