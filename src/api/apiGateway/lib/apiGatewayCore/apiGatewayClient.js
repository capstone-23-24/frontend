...
import apiGatewaySigV4 from "./sigV4Client";
import apiGatewayhttp from './simpleHttpClient'
...
apiGateway.core.apiGatewayClientFactory.newClient = function (simpleHttpClientConfig, sigV4ClientConfig) {
    ...
    var sigV4Client = apiGatewaySigV4.core.sigV4ClientFactory.newClient(sigV4ClientConfig);
    var simpleHttpClient = apiGatewayhttp.core.simpleHttpClientFactory.newClient(simpleHttpClientConfig);
    ...
    apiGatewayClient.makeRequest = function (request, authType, additionalParams, apiKey) {
        ...
        request.headers = apiGatewayUtils.core.utils.mergeInto(request.headers, additionalParams.headers);
        request.queryParams = apiGatewayUtils.core.utils.mergeInto(request.queryParams, additionalParams.queryParams);
